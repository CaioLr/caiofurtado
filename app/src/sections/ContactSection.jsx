...
const ContactSection = () => {
  return (
    <section id='contact' className='relative w-full h-screen flex flex-col items-center justify-center snap-center'>
        ...
        <div className='flex flex-row h-1/4 w-2/4 gap-8 items-center justify-between'>
            <div className='flex w-1/6 aspect-square items-center justify-center bg-gray-50 shadow-md shadow-black/30 rounded-full'><a className='w-full h-full flex items-center justify-center' href="https://www.linkedin.com/in/caio-furtado-ramos/" target="_blank">
                <img className='w-2/4 object-cover' src="/linkedinlogo.png" alt="LinkedIn" />
            </a></div>

            <div className='flex w-1/6 aspect-square items-center justify-center bg-gray-50 shadow-md shadow-black/30 rounded-full'> <a className='w-full h-full flex items-center justify-center' href="https://www.youtube.com/@CaioFurtadoLr" target="_blank">
                <img className='w-4/4 object-cover' src="/youtubelogo.png" alt="YouTube" />
            </a></div>

            <div className='flex w-1/6 aspect-square items-center justify-center bg-gray-50 shadow-md shadow-black/30 rounded-full'><a className='w-full h-full flex items-center justify-center' href="https://github.com/CaioLr" target="_blank">
