...
const ProjectsSection = () => {
  return (
    <section id="projects" className='relative w-full h-screen flex flex-col items-center gap-8 justify-start lg:justify-center snap-center'>

        <div className='absolute z-10 w-[31.7rem] h-[31.7rem] xl:w-[37.35rem] xl:h-[37.35rem] 2xl:w-[41.5rem] 2xl:h-[41.5rem] left-0 flex flex-col justify-start lg:justify-center'>
            <p className='Oswald text-2xl lg:text-4xl px-10 py-4 mb-0 lg:mb-8'>Take a look at my projects and explore the details of it in my projects page.</p>
            <p className='hidden lg:flex open-sans-regular text-lg px-10 pb-4'>Visit my projects page to learn more about the challenges and technologies I’ve worked with. There you’ll find more details about the concepts, planning stages, and development processes of the projects I’ve been involved in.</p>
        ...
        <div className='absolute  rotate-x-30 rotate-z-20 -right-180 lg:-right-100 xl:-right-80 2xl:-right-60 -bottom-35 w-[68.85rem] h-[53.55rem] xl:w-[81rem] xl:h-[63rem] 2xl:w-[90rem] 2xl:h-[70rem] rounded-2xl border border-stone-500  p-12 '>
